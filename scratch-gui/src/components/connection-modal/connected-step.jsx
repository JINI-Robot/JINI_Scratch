        ...
        <Box className={styles.activityArea}>
            <Box className={styles.centeredRow}>
                <div className={styles.peripheralActivity}>
                    ...
                    />
                    {
                        props.name.indexOf('AIBot') > -1  ? <img className={styles.extensionConnectedIcon} src={usbIcon}/> :
                        props.name.indexOf('ToyBot') > -1 ? <img className={styles.extensionConnectedIcon} src={usbIcon}/> :
                        <img className={styles.extensionConnectedIcon} src={bluetoothIcon}/>
                    }
                </div>
            </Box>
        </Box>
