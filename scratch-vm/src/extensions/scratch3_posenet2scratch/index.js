...
const Message = {
  ...
  getX: {
    ...
    'ko': '[PERSON_NUMBER]번째 사람의 [PART] X좌표',
  ...
  getY: {
    ...
    'ko': '[PERSON_NUMBER]번째 사람의 [PART] Y좌표',
...
const AvailableLocales = ['ko','en', 'ja', 'ja-Hira', 'zh-tw'];
...
class Scratch3Posenet2ScratchBlocks {
    ...
    static get EXTENSION_NAME() {
      return Message.name[this.locale];
    }
    ...
    getX (args) {
      if (this.poses[parseInt(args.PERSON_NUMBER, 10) - 1] && this.poses[parseInt(args.PERSON_NUMBER, 10) - 1].pose.keypoints[parseInt(args.PART, 10)]) {
        ...
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.poses[parseInt(args.PERSON_NUMBER, 10) - 1].pose.keypoints[parseInt(args.PART, 10)].position.x);
        } else {
          x = 240 - this.poses[parseInt(args.PERSON_NUMBER, 10) - 1].pose.keypoints[parseInt(args.PART, 10)].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getY (args) {
      if (this.poses[parseInt(args.PERSON_NUMBER, 10) - 1] && this.poses[parseInt(args.PERSON_NUMBER, 10) - 1].pose.keypoints[parseInt(args.PART, 10)]) {
        let y = 180 - this.poses[parseInt(args.PERSON_NUMBER, 10) - 1].pose.keypoints[parseInt(args.PART, 10)].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getNoseX () {
      if (this.keypoints[0]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[0].position.x);
        } else {
          x = 240 - this.keypoints[0].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getNoseY () {
      if (this.keypoints[0]) {
        let y = 180 - this.keypoints[0].position.y;
        return Math.round(y)
      } else {
        return "";
      }
    ...
    getLeftEyeX () {
      if (this.keypoints[1]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[1].position.x);
        } else {
          x = 240 - this.keypoints[1].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getLeftEyeY () {
      if (this.keypoints[1]) {
        let y = 180 - this.keypoints[1].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getRightEyeX () {
      if (this.keypoints[2]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[2].position.x);
        } else {
          x = 240 - this.keypoints[2].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getRightEyeY () {
      if (this.keypoints[2]) {
        let y = 180 - this.keypoints[2].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getLeftEarX () {
      if (this.keypoints[3]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[3].position.x);
        } else {
          x = 240 - this.keypoints[3].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getLeftEarY () {
      if (this.keypoints[3]) {
        let y = 180 - this.keypoints[3].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getRightEarX () {
      if (this.keypoints[4]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[4].position.x);
        } else {
          x = 240 - this.keypoints[4].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getRightEarY () {
      if (this.keypoints[4]) {
        let y = 180 - this.keypoints[4].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getLeftWristX () {
      if (this.keypoints[9]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[9].position.x);
        } else {
          x = 240 - this.keypoints[9].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getLeftWristY () {
      if (this.keypoints[9]) {
        let y = 180 - this.keypoints[9].position.y;
        return Math.round(y);
      } else {
        return "";
      }
    ...
    getRightWristX () {
      if (this.keypoints[10]) {
        let x = 0;
        if (this.runtime.ioDevices.video.mirror === false) {
          x = -1 * (240 - this.keypoints[10].position.x);
        } else {
          x = 240 - this.keypoints[10].position.x;
        }
        return Math.round(x);
      } else {
        return "";
    ...
    getRightWristY () {
      if (this.keypoints[10]) {
        let y = 180 - this.keypoints[10].position.y;
        return Math.round(y);
      } else {
        return "";
      }
