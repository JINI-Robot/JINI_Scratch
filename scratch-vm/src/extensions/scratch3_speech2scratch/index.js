...
class Scratch3Speech2Scratch {
    ...
    static get EXTENSION_NAME() {
        return Message.name[this._locale];
    }
    ...
    constructor (runtime) {
        ...
        this.recognitionStartFlag = false;
        this.recognitionInterval = 5000; // ５sec.
    }
    ...
    getInfo () {
        return {
            ...
            name: Message.name[this._locale],
            ...
            blocks: [
                {
                    ...
                    text: Message.item[this._locale]
                },
                {
                    opcode: 'getSpeech',
                    blockType: BlockType.REPORTER,
                    text: Message.cont[this._locale]
                }
            ],
            menus: {
            }
    ...
    startRecognition () {
        if (!this.recognitionStartFlag) {
            this.recognitionStartFlag = true;
            
            const recognition = new SpeechRecognition();
            recognition.lang = this.setLocale() === 'ko' ? 'ko-KR' : 'en-US';
